...
class Enemies:
    ...
    def __init__(self, enemies_num, width, height, GAME_BASE, GAME_HEIGHT, DISPLAY_BASE, DISPLAY_HEIGHT,walls:Walls):
        ...
        self.create_units(walls)

    def create_units(self,walls:Walls):
        ...
        for i in range(self.number):
            ...
            self.units.append(
                Enemy(RED, 
                      self.unit_width, 
                      self.unit_height, 
                      x*70 + 35, # xpos. Temporary until I make a placement function
                      y*70 + 35, # ypos. Temporary until I make a placement function
                      self.DISPLAY_HEIGHT, 
                      self.DISPLAY_BASE, 
                      self.GAME_BASE, 
                      self.GAME_HEIGHT)
